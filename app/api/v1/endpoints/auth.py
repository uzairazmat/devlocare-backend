...
Rate limits (FRD §6 — Tools/security):
    POST /auth/register : settings.RATE_LIMIT_REGISTER (default 10/hour)
    POST /auth/login    : settings.RATE_LIMIT_LOGIN    (default  5/minute)
    POST /auth/token    : settings.RATE_LIMIT_LOGIN
Limits are keyed by client IP via slowapi.
"""
